...
//	chatService crep;
	...
	String eg1controller(@PathVariable(required=false) String id,@RequestBody(required=false) String val1) {
...
//		return crep.findAllSortedByChatId();
		return crep.findAllChat();
	}
}
